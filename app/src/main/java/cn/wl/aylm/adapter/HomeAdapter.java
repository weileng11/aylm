...
public class HomeAdapter extends BaseNormalAdapter<PublicInfo>{
...
//    }
    ...
    public View builderItemView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.home_gv_item, parent, false);
            holder.tvName = (TextView) convertView.findViewById(R.id.home_tv_content);
            holder.imgItem = (ImageView) convertView.findViewById(R.id.home_iv_item);
